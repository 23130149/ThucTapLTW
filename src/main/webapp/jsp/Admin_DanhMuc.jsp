...
<aside class="sliderbar">
    ...
    <nav class="slidebar-nav">
        <ul>
            ...
            <li class="active"><a href="${pageContext.request.contextPath}/jsp/Admin_DanhMuc.jsp"><i class="bx bx-category"></i>Danh mục</a></li>
            ...
            <li><a href="${pageContext.request.contextPath}/jsp/Admin_Banner.jsp"><i class="bx bx-image"></i>Banner</a></li>
